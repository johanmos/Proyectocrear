            ...
            <div class="row">
                <div class="service-base col-sm-12 no-padding">
                    <div class="col-sm-6 service-block text-center animate-in move-up">
                        <img src="http://www.hoplasoftware.com/wp-uploads/2015/02/products-icon.png" width="350px" alt="service">
...
?>				
                        <p class="centrado">
						 <img width="10px" src="https://encrypted-tbn1.gstatic.com/images?q=tbn:ANd9GcRWxC0nUjxasijGQEzVnn-rc3ps7NsMlbXRGzeXzFgBx1nSihtu">  
						 <a href="collection.php?categoria=<?php echo $row['nombre'];?>">
						 <?php echo $row['nombre']; ?>						 	
						 </a><br> 
