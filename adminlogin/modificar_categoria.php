        ...
        <div class="row m-t-50">
            <div class="col-xs-12 col-sm-6">
                <h4 class="header-title m-t-0">Modificar Logo</h4>
                    ...
                    <form action="../agregar_categorias/proceso_modificar.php?id=<?php echo $row['id'];?>" method="POST" role="form" enctype="multipart/form-data"> 
                    <p>Desde aqui podras actualizar el nombre de la categoría, si deseas cambiar tambien la imagen, dale click en actualizar imagen</p>
                    <br><label>Nombre</label><br><input type="text" REQUIRED name="name" placeholder="escribe categoria" value="<?php echo $row['nombre'];?>"/><br><br>
                    <label>Imagen Actual</label></br>
                    <img width="120px" src="data:image/jpg;base64,<?php echo base64_encode($row['imagen']);?>"/><br><br>

                    <button type="submit" class="btn btn-danger">Guardar cambios</button>
                    <a href="modificar_categoria_imagen.php?id=<?php echo $row['id'];?>">Actualizar imagen</a>
                    </form>                    
            </div>
        </div>
