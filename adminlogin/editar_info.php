					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Editar Información</h4>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <form action="../informacion/editar_info.php" method="POST" enctype="multipart/form-data">
                                        <input type="text" class="form-control" name="direccion" id="" value="<?php echo $row['direccion']; ?>">
                                        <br>
                                        <input type="text" class="form-control" name="telefono" id="" value="<?php echo $row['telefono']; ?>">
                                        <br>
                                        <input type="text" class="form-control" name="email" id="" value="<?php echo $row['email']; ?>">
                                        <br>
                                        <label>Facebook</label>
                                        <input type="text" class="form-control" name="facebook" id="" value="<?php echo $row['facebook']; ?>">
                                        <br>
                                        <label>Pinterest</label>
                                        <input type="text" class="form-control" name="pinterest" id="" value="<?php echo $row['pinterest']; ?>">
                                        <br>
                                        <label>Twitter</label>
                                        <input type="text" class="form-control" name="twitter" id="" value="<?php echo $row['twitter']; ?>">
                                        <br>
                                        <br>
