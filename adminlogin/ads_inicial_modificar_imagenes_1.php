                                ...
                                <div class="card-box">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table m-0">
                                            <thead>
                                                <tr>
                                                    <th>Tu Imagen Actual</th>
                                                    <th>Subir nueva imagen</th>                                                   
...
<?php
    ...
    <tbody>
    <tr>
         <form action="../pub_inicial/subir/modificar_imagen.php?id=<?php echo $f['id'];?>" method="POST" enctype="multipart/form-data">
        <td><img width="200px" src="../pub_inicial/Subir/Imagenes/<?php echo $f['Imagen']; ?>"><br></td>
