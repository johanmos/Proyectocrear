...
<head>
	...
	<meta charset="utf-8">
	<title>Today's Deals  - Home Market Red</title>
	<!-- Font ================================================== -->
				...
				<div class="grid">
					<div class="grid__item">
						...
						<?php
							if($count == 0)
							{
								$output = 'No hubo resultado de busqueda';
							}
							else
							{	
								...
								<div class="grid__item large--one-fifth medium--one-quarter">
									<div class="grid__item_wrapper">
											<div class="grid__image product-image">
													<a href="product.html">
														<img src="<?php echo $row['imagen1'];?>" alt="Demo Product Sample">
													</a>
											</div>
													
													<p class="h6 product-title">
														<a href="product.html"><?php echo $nombre; ?></a>
													</p>
