...
require_once('../conexion.php');
                        ...
                        ?>
                                            <tbody>
                                                <tr>
                                                    <?php echo "<td><img src='../blog/imagenes/".$row["imagen_post"]."'  height='70' width='70'><br></td>"?>
                                                    <td><?php echo $row['titulo_post'];?></td>
                                                    <td><?php echo $row['autor_post'];?></td>
                                                    <td><?php echo $row['fecha_post'];?></td>
                                                     <td>Ver</td>
                                                    <td><a href="editar_post_blog.php?id=<?php echo $id; ?>">Editar</a></td>
                                                    <td><a href="../blog/eliminar_post.php?id=<?php echo $id; ?>" onclick="return confirm('Esta seguro que desea eliminar este post?');">Eliminar</a><td>
