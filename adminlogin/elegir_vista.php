					...
					<div class="container">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <h4 class="page-title">Elegir Slider Inferior Principal</h4>
                                <?php
                                ...
                                if (isset($_REQUEST['res'])) {
                                       ...
                                       if($_REQUEST['res']==1)
                                       {
                                        print "<h5> Cambio realizado con éxito </h5>";
                                       }
                                 }
...
$result= $link->query($sql);
    ...
    ?>
    <tbody>
    <form name="formulario" method="post" action="../elegir_vista/guardar_selec_vista.php" enctype="multipart/form-data">
