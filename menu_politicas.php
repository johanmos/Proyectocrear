...
<center><h4 style="color:red;">Como realizo un pedido?</h4></center><br>
  <div class="service-base col-sm-12 no-padding">
    <div class="col-sm-6 service-block text-center animate-in move-up">
      <br>
      <p class="centrado">
      <img src="assets/images/check.png">Selecciona los prodcutos que desees y dales click en "Cotizar" 
      <br> 
      <img src="assets/images/check.png">Ve al Carrito de compras en la parte superior derecha
      <br>
      <img src="assets/images/check.png">Verifica tus productos deseados
      <br>
      <img src="assets/images/check.png">Dale click en ver cotización
      <br>
      <img src="assets/images/check.png">Completa los datos y envia el formulario
      <br>
      <img src="assets/images/check.png">Listo! Nos pondremos en contacto con tigo y tendras tu cotización en tu correo electrónico
      </p>
    </div>
    <div class="col-sm-6 service-block text-center animate-in move-up">
    <br><br>
    <img src="http://decorateca.com/img/cms/ENVIOS.png" width="200px" alt="service">
    </div>
    </div> 
</div>
<br>
